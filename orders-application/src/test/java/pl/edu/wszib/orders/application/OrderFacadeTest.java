...
public class OrderFacadeTest {
    ...
    @Test
    public void should_be_not_able_to_remove_products_from_not_existing_order() {
    ...
    @Test
    public void should_not_be_able_to_decrease_product_quantity_in_not_exusting_order(){
